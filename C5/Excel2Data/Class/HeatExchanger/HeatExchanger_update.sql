...
COMMENT ON COLUMN "public"."bak_heat_exchanger_15m"."heat_ex_electric_heating_status" IS '电加热状态'; 
...
ADD COLUMN heat_ex_low_temp float8,
ADD COLUMN heat_ex_return_air_temp_sensor_fault int8; 
COMMENT ON COLUMN "public"."bak_heat_exchanger_1h"."heat_ex_electric_heating_status" IS '电加热状态'; 
