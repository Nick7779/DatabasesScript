DROP TABLE IF EXISTS "public"."bak_air_con_15m";
                        CREATE TABLE "public"."bak_air_con_15m" (
                      "id" int8,
...
air_con_external_fan_speed float8,
...
air_con_sensitivity_temp_setting_value float8,
air_con_temp_setting float8,
air_con_remote_start_stop int8,
air_con_dc_ov_alarm_setting float8,
air_con_dc_uv_alarm_setting float8,
air_con_dc_power_off_voltage_setting float8,
air_con_ac_ov_setting float8,
air_con_ac_uv_setting float8,
air_con_compressor_temp_difference float8,
air_con_low_temp_setting float8,
air_con_heater_startup_temp_setting float8,
air_con_heater_temp_difference float8,
air_con_high_temp int8,
air_con_low_temp int8,
air_con_dc_ov_alarm int8,
air_con_dc_uv_alarm int8,
air_con_ac_ov_alarm int8,
air_con_ac_uv_alarm int8,
air_con_self_check_status int8,
air_con_return_air_temp_sensor_fault int8,
air_con_internal_fan2_status int8,
air_con_external_fan2_status int8,
air_con_internal_fan2_speed int8,
air_con_external_fan2_speed int8,
air_con_internal_temp float8,
air_con_external_temp float8,
air_con_delta_temp_of_heater float8,
air_con_calibration_of_indoor_temp float8,
air_con_calibration_of_condenser_temp float8,
air_con_calibration_of_heater_current float8,
air_con_calibration_of_dc_voltage float8,
air_con_internal_fan2_fault int8,
air_con_external_fan2_fault int8,
air_con_compressor_driver_communicate_fault int8,
air_con_heater_alarm int8,
air_con_heater_over_current_alarm int8,
air_con_heater_non_current_alarm int8,
air_con_internal_temp_sensor_alarm int8,
air_con_external_input_alarm int8,
air_con_heater_overload_alarm int8,
air_con_heater_underload_alarm int8,
air_con_door_alarm int8,
air_con_water_alarm int8,
air_con_smoke_alarm int8); 
COMMENT ON COLUMN "public"."bak_air_con_15m"."id" IS '主键';
COMMENT ON COLUMN "public"."bak_air_con_15m"."create_time" IS '创建时间';
...
DROP TABLE IF EXISTS "public"."bak_air_con_1h";
                            CREATE TABLE "public"."bak_air_con_1h" (
                          "id" int8,
                          "create_time" timestamp(6),
                          "customer_id" int8,
                          "site_id" int8,
...
air_con_water_alarm int8,
air_con_smoke_alarm int8); 
COMMENT ON COLUMN "public"."bak_air_con_1h"."id" IS '主键';
    COMMENT ON COLUMN "public"."bak_air_con_1h"."create_time" IS '创建时间';
