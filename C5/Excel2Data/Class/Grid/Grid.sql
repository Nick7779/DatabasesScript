...
grid_phase_power_negative_a float8,
grid_phase_power_negative_b float8,
grid_phase_power_negative_c float8,
grid_current_sequence_error float8,
grid_voltage_sequence_error float8,
grid_ac1_mains_failure float8,
grid_ac_alarm_state float8,
grid_three_phase_ac_energy_meter_alarms float8,
grid_s1_mains_energy float8,
grid_s1_breaker_closed float8,
grid_status float8,
grid_voltage_phase_lag_lead float8,
grid_phase_rotation float8,
grid_current_lag_lead float8,
grid_earth_current float8,
grid_average_power_factor float8,
grid_led_status float8); 
...
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_s1_normal" IS 'S1 正常灯'; 
...
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_reverse_active_total_energy" IS '反向有功总能量'; 
...
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_comp_reactive_power2_total_electric_energy" IS '综合无功功率2总电能'; 
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_comp_reactive_power1_total_electric_energy" IS '综合无功功率1总电能'; 
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_total_harmonic_distortion_of_current" IS '电流总谐波失真'; 
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_phase_power_negative_a" IS 'A相功率为负'; 
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_phase_power_negative_b" IS 'B相功率为负'; 
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_phase_power_negative_c" IS 'C相功率为负'; 
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_current_sequence_error" IS '电流相序错误'; 
...
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_three_phase_ac_energy_meter_alarms" IS '三相电能表父级告警'; 
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_s1_mains_energy" IS 'S1市电能量'; 
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_s1_breaker_closed" IS 'S1断路器闭合'; 
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_status" IS '市电状态'; 
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_voltage_phase_lag_lead" IS '市电电压相位滞后/超前'; 
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_phase_rotation" IS '市电相位旋转'; 
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_current_lag_lead" IS '市电电流滞后/超前'; 
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_earth_current" IS '市电接地电流'; 
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_average_power_factor" IS '市电平均功率因数'; 
COMMENT ON COLUMN "public"."iot_grid_15m"."grid_led_status" IS '市电LED状态'; 
...
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_s1_normal" IS 'S1 正常灯'; 
...
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_reverse_active_total_energy" IS '反向有功总能量'; 
...
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_comp_reactive_power2_total_electric_energy" IS '综合无功功率2总电能'; 
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_comp_reactive_power1_total_electric_energy" IS '综合无功功率1总电能'; 
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_total_harmonic_distortion_of_current" IS '电流总谐波失真'; 
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_phase_power_negative_a" IS 'A相功率为负'; 
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_phase_power_negative_b" IS 'B相功率为负'; 
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_phase_power_negative_c" IS 'C相功率为负'; 
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_current_sequence_error" IS '电流相序错误'; 
...
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_three_phase_ac_energy_meter_alarms" IS '三相电能表父级告警'; 
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_s1_mains_energy" IS 'S1市电能量'; 
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_s1_breaker_closed" IS 'S1断路器闭合'; 
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_status" IS '市电状态'; 
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_voltage_phase_lag_lead" IS '市电电压相位滞后/超前'; 
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_phase_rotation" IS '市电相位旋转'; 
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_current_lag_lead" IS '市电电流滞后/超前'; 
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_earth_current" IS '市电接地电流'; 
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_average_power_factor" IS '市电平均功率因数'; 
COMMENT ON COLUMN "public"."iot_grid_1h"."grid_led_status" IS '市电LED状态'; 
