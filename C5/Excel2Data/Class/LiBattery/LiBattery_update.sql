ALTER TABLE bak_li_battery_15m 
ADD COLUMN li_ba_voltage float8,
ADD COLUMN li_ba_current float8,
ADD COLUMN li_ba_cycles_number int8,
ADD COLUMN li_ba_total_capacity float8,
ADD COLUMN li_ba_soc float8,
ADD COLUMN li_ba_soh float8,
ADD COLUMN li_ba_ambient_temp float8,
ADD COLUMN li_ba_cells_maximum_voltage float8,
ADD COLUMN li_ba_cells_minimum_voltage float8,
ADD COLUMN li_ba_cells_average_voltage float8,
ADD COLUMN li_ba_internal_temp1 float8,
ADD COLUMN li_ba_internal_temp2 float8,
ADD COLUMN li_ba_internal_temp3 float8,
ADD COLUMN li_ba_internal_temp4 float8,
ADD COLUMN li_ba_internal_temp5 float8,
ADD COLUMN li_ba_internal_temp6 float8,
ADD COLUMN li_ba_cores_number int8,
ADD COLUMN li_ba_light_discharge_time float8,
ADD COLUMN li_ba_deep_discharge_time float8,
ADD COLUMN li_ba_over_discharge_time float8,
ADD COLUMN li_ba_shallow_discharge_high16_bit float8,
ADD COLUMN li_ba_deep_discharge_high16_bit float8,
ADD COLUMN li_ba_over_discharge_high16_bit float8,
ADD COLUMN li_ba_shallow_discharge_low16_bit float8,
ADD COLUMN li_ba_deep_discharge_low16_bit float8,
ADD COLUMN li_ba_overdischarge_low16_bit float8,
ADD COLUMN li_ba_cell1_voltage float8,
ADD COLUMN li_ba_cell2_voltage float8,
ADD COLUMN li_ba_cell3_voltage float8,
ADD COLUMN li_ba_cell4_voltage float8,
ADD COLUMN li_ba_cell5_voltage float8,
ADD COLUMN li_ba_cell6_voltage float8,
ADD COLUMN li_ba_cell7_voltage float8,
ADD COLUMN li_ba_cell8_voltage float8,
ADD COLUMN li_ba_cell9_voltage float8,
ADD COLUMN li_ba_cell10_voltage float8,
ADD COLUMN li_ba_cell11_voltage float8,
ADD COLUMN li_ba_cell12_voltage float8,
ADD COLUMN li_ba_cell13_voltage float8,
ADD COLUMN li_ba_cell14_voltage float8,
ADD COLUMN li_ba_cell15_voltage float8,
ADD COLUMN li_ba_cell16_voltage float8,
ADD COLUMN li_ba_cell17_voltage float8,
ADD COLUMN li_ba_cell18_voltage float8,
ADD COLUMN li_ba_cell19_voltage float8,
ADD COLUMN li_ba_cell20_voltage float8,
ADD COLUMN li_ba_cell21_voltage float8,
ADD COLUMN li_ba_cell22_voltage float8,
ADD COLUMN li_ba_cell23_voltage float8,
ADD COLUMN li_ba_cell24_voltage float8,
ADD COLUMN li_ba_cell25_voltage float8,
ADD COLUMN li_ba_cell26_voltage float8,
ADD COLUMN li_ba_cell27_voltage float8,
ADD COLUMN li_ba_cell28_voltage float8,
ADD COLUMN li_ba_cell29_voltage float8,
ADD COLUMN li_ba_cell30_voltage float8,
ADD COLUMN li_ba_power_temp float8,
ADD COLUMN li_ba_status int8,
ADD COLUMN li_ba_fet_status float8,
ADD COLUMN li_ba_cell_temp_highest float8,
ADD COLUMN li_ba_cell_temp_lowest float8,
ADD COLUMN li_ba_vbus float8,
ADD COLUMN li_ba_bms_protection_status int8,
ADD COLUMN li_ba_bms_parallel_online_units int8,
ADD COLUMN li_ba_total_charge_capacity float8,
ADD COLUMN li_ba_total_charge_time int8,
ADD COLUMN li_ba_total_discharge_time int8,
ADD COLUMN li_ba_remaining_capacity float8,
ADD COLUMN li_ba_alarm_status1 int8,
ADD COLUMN li_ba_alarm_status2 int8,
ADD COLUMN li_ba_alarm_status3 int8,
ADD COLUMN li_ba_alarm_status4 int8,
ADD COLUMN li_ba_alarm_status5 int8,
ADD COLUMN li_ba_ambient_temp_alarm_status_dz int8,
ADD COLUMN li_ba_power_temp_alarm_status_dz int8,
ADD COLUMN li_ba_charging_and_discharging_flow_alarm_status int8,
ADD COLUMN li_ba_bms_voltage_alarm_status_dz int8,
ADD COLUMN li_ba_bms_remaining_capacity_alarm_status_dz int8,
ADD COLUMN li_ba_bms_static_balance_indication_dz int8,
ADD COLUMN li_ba_bms_static_balancing_timeout_dz int8,
ADD COLUMN li_ba_bms_overtemp_disables_balancing_dz int8,
ADD COLUMN li_ba_cell_failure_alarm_dz int8,
ADD COLUMN li_ba_cell_ov_alarm_dz int8,
ADD COLUMN li_ba_cell_ov_protection_dz int8,
ADD COLUMN li_ba_cell_uv_alarm_dz int8,
ADD COLUMN li_ba_cell_uv_protection_dz int8,
ADD COLUMN li_ba_overall_ov_alarm_dz int8,
ADD COLUMN li_ba_overall_ov_protection_dz int8,
ADD COLUMN li_ba_overall_uv_alarm_dz int8,
ADD COLUMN li_ba_overall_uv_protection_dz int8,
ADD COLUMN li_ba_charging_high_temp_alarm_dz int8,
ADD COLUMN li_ba_charging_over_temp_protection_dz int8,
ADD COLUMN li_ba_charging_low_temp_alarm_dz int8,
ADD COLUMN li_ba_charging_under_temp_protection_dz int8,
ADD COLUMN li_ba_discharge_high_temp_alarm_dz int8,
ADD COLUMN li_ba_discharge_over_temp_protection_dz int8,
ADD COLUMN li_ba_discharge_low_temp_alarm_dz int8,
ADD COLUMN li_ba_discharge_under_temp_protection_dz int8,
ADD COLUMN li_ba_ambient_high_temp_alarm_dz int8,
ADD COLUMN li_ba_ambient_overtemp_protection_dz int8,
ADD COLUMN li_ba_ambient_low_temp_alarm_dz int8,
ADD COLUMN li_ba_ambient_under_temp_protection_dz int8,
ADD COLUMN li_ba_power_over_temp_protection_dz int8,
ADD COLUMN li_ba_charge_current_alarm_dz int8,
ADD COLUMN li_ba_charge_overcurrent_protection_dz int8,
ADD COLUMN li_ba_discharge_current_alarm_dz int8,
ADD COLUMN li_ba_discharge_overcurrent_protection_dz int8,
ADD COLUMN li_ba_secondary_overcurrent_protection_dz int8,
ADD COLUMN li_ba_secondary_overcurrent_lock_dz int8,
ADD COLUMN li_ba_output_short_circuit_lock_dz int8,
ADD COLUMN li_ba_remaining_capacity_alarm_dz int8,
ADD COLUMN li_ba_discharge_switch_on_dz int8,
ADD COLUMN li_ba_charging_switch_on_dz int8,
ADD COLUMN li_ba_current_limit_switch_on_dz int8,
ADD COLUMN li_ba_heating_switch_on_dz int8,
ADD COLUMN li_ba_discharge_dz int8,
ADD COLUMN li_ba_charge_dz int8,
ADD COLUMN li_ba_float_dz int8,
ADD COLUMN li_ba_ntc_disconnect int8,
ADD COLUMN li_ba_adc_damage int8,
ADD COLUMN li_ba_reverse_connect int8,
ADD COLUMN li_ba_fan_on_fault int8,
ADD COLUMN li_ba_lock int8,
ADD COLUMN li_ba_low_cell_voltage_fault int8,
ADD COLUMN li_ba_voltage_sampling_disconnect int8,
ADD COLUMN li_ba_charge_mos_damage int8,
ADD COLUMN li_ba_discharge_mos_damage int8,
ADD COLUMN li_ba_voltage_sampling_element_damaged int8,
ADD COLUMN li_ba_charge_state_for_single_battery int8,
ADD COLUMN li_ba_discharge_state_for_single_battery int8,
ADD COLUMN li_ba_short_circuit_protection int8,
ADD COLUMN li_ba_ov_protection int8,
ADD COLUMN li_ba_uv_protection int8,
ADD COLUMN li_ba_overall_ov_protection int8,
ADD COLUMN li_ba_fail_to_start int8,
ADD COLUMN li_ba_charge_mos_conduction_state int8,
ADD COLUMN li_ba_discharge_mos_conduction_state int8,
ADD COLUMN li_ba_force_charge_mos_on int8,
ADD COLUMN li_ba_force_charge_mos_off int8,
ADD COLUMN li_ba_forced_discharge_mos_on int8,
ADD COLUMN li_ba_forced_discharge_mos_off int8,
ADD COLUMN li_ba_heating_pad_on int8,
ADD COLUMN li_ba_mosfet_over_temp_protection int8,
ADD COLUMN li_ba_mosfet_low_temp_protection int8,
ADD COLUMN li_ba_charging_temp_too_low int8,
ADD COLUMN li_ba_ambient_temp_low_protection int8,
ADD COLUMN li_ba_ambient_temp_high_protection int8,
ADD COLUMN li_ba_fan_on int8,
ADD COLUMN li_ba_vibration_alarm int8,
ADD COLUMN li_ba_dry_contact1 int8,
ADD COLUMN li_ba_dry_contact2 int8,
ADD COLUMN li_ba_bms_module_sn_repetition int8,
ADD COLUMN li_ba_cell_ov_alarm int8,
ADD COLUMN li_ba_cell_uv_alarm int8,
ADD COLUMN li_ba_overall_ov_alarm int8,
ADD COLUMN li_ba_overall_uv_alarm int8,
ADD COLUMN li_ba_overcharge_alarm int8,
ADD COLUMN li_ba_discharge_overcurrent_alarm int8,
ADD COLUMN li_ba_charging_over_temp_alarm int8,
ADD COLUMN li_ba_charge_under_temp_alarm int8,
ADD COLUMN li_ba_ambient_temp_high_alarm int8,
ADD COLUMN li_ba_ambient_temp_low_alarm int8,
ADD COLUMN li_ba_mos_over_temp_alarm int8,
ADD COLUMN li_ba_discharge_overheating_alarm int8,
ADD COLUMN li_ba_discharge_under_temp_alarm int8,
ADD COLUMN li_battery_sob_fc float8,
ADD COLUMN li_ba_bank_voltage float8,
ADD COLUMN li_ba_total_current float8,
ADD COLUMN li_ba_light_discharge_counts int8,
ADD COLUMN li_ba_deep_discharge_counts int8,
ADD COLUMN li_ba_over_discharge_counts int8,
ADD COLUMN li_ba_discharge_energy_single float8,
ADD COLUMN li_ba_current_alarm_status int8,
ADD COLUMN li_ba_bms_balance_event_alarm_status_dz int8,
ADD COLUMN li_ba_bms_voltage_event_alarm_status_dz int8,
ADD COLUMN li_ba_temp_event_alarm_status_dz int8,
ADD COLUMN li_ba_current_event_alarm_status int8,
ADD COLUMN li_ba_positive_fuse_alarm_state int8,
ADD COLUMN li_ba_bms_alarm_state int8,
ADD COLUMN li_ba_temp_alarm_state1 int8,
ADD COLUMN li_ba_temp_alarm_state2 int8,
ADD COLUMN li_ba_break int8,
ADD COLUMN li_ba_negative_break int8,
ADD COLUMN li_ba_charge_overcurrent int8,
ADD COLUMN li_ba_middle_imbalance int8,
ADD COLUMN li_ba_cant_charge int8,
ADD COLUMN li_ba_total_alarm int8,
ADD COLUMN li_ba_overcurrent int8,
ADD COLUMN li_ba_pack_ov int8,
ADD COLUMN li_ba_packs_uv int8,
ADD COLUMN li_ba_output_short_circuit int8,
ADD COLUMN li_ba_high_temp int8,
ADD COLUMN li_ba_low_temp int8,
ADD COLUMN li_ba_low_soc int8,
ADD COLUMN li_ba_battery_temp1_high1 int8,
ADD COLUMN li_ba_battery_temp2_high1 int8,
ADD COLUMN li_ba_battery_temp1_high2 int8,
ADD COLUMN li_ba_battery_temp2_high2 int8,
ADD COLUMN li_ba_battery_temp1_low1 int8,
ADD COLUMN li_ba_battery_temp1_low2 int8,
ADD COLUMN li_ba_battery_temp2_low1 int8,
ADD COLUMN li_ba_battery_temp2_low2 int8,
ADD COLUMN li_ba_btrm1 int8,
ADD COLUMN li_ba_btrm2 int8,
ADD COLUMN li_ba_alarm_state1 int8,
ADD COLUMN li_ba_bms1_comm_fault int8,
ADD COLUMN li_ba_bms2_comm_fault int8,
ADD COLUMN li_ba_bms3_comm_fault int8,
ADD COLUMN li_ba_bms4_comm_fault int8,
ADD COLUMN li_ba_bms5_comm_fault int8,
ADD COLUMN li_ba_bms6_comm_fault int8,
ADD COLUMN li_ba_bms7_comm_fault int8,
ADD COLUMN li_ba_bms8_comm_fault int8,
ADD COLUMN li_ba_bms9_comm_fault int8,
ADD COLUMN li_ba_bms10_comm_fault int8,
ADD COLUMN li_ba_bms11_comm_fault int8,
ADD COLUMN li_ba_bms12_comm_fault int8,
ADD COLUMN li_ba_bms13_comm_fault int8,
ADD COLUMN li_ba_bms14_comm_fault int8,
ADD COLUMN li_ba_bms15_comm_fault int8,
ADD COLUMN li_ba_bms16_comm_fault int8,
ADD COLUMN li_ba_bms17_comm_fault int8,
ADD COLUMN li_ba_bms18_comm_fault int8,
ADD COLUMN li_ba_bms19_comm_fault int8,
ADD COLUMN li_ba_bms20_comm_fault int8,
ADD COLUMN li_ba_comm_alarm_state2 int8,
ADD COLUMN li_ba_bms_alarm_status5 int8,
ADD COLUMN li_ba_bms_alarm_status4 int8,
ADD COLUMN li_ba_bms_alarm_status3 int8,
ADD COLUMN li_ba_bms_alarm_status2 int8,
ADD COLUMN li_ba_charge_under_temp_protection int8,
ADD COLUMN li_ba_charge_over_temp_protection int8,
ADD COLUMN li_ba_bms_alarm_status1 int8,
ADD COLUMN li_ba_cell_ov_alarm_smart int8,
ADD COLUMN li_ba_cell_uv_alarm_smart int8,
ADD COLUMN li_ba_overall_ov_warning int8,
ADD COLUMN li_ba_low_soc_smart int8,
ADD COLUMN li_ba_voltage_difference_alarm int8,
ADD COLUMN li_ba_bms_system_status_dz int8,
ADD COLUMN li_ba_fully_charge_dz int8,
ADD COLUMN li_ba_standby_dz int8,
ADD COLUMN li_ba_shutdown_dz int8,
ADD COLUMN li_ba_bms_balance_status_dz int8,
ADD COLUMN li_ba_cell1_balance_indication_dz int8,
ADD COLUMN li_ba_cell2_balance_indication_dz int8,
ADD COLUMN li_ba_cell3_balance_indication_dz int8,
ADD COLUMN li_ba_cell4_balance_indication_dz int8,
ADD COLUMN li_ba_cell5_balance_indication_dz int8,
ADD COLUMN li_ba_cell6_balance_indication_dz int8,
ADD COLUMN li_ba_cell7_balance_indication_dz int8,
ADD COLUMN li_ba_cell8_balance_indication_dz int8,
ADD COLUMN li_ba_cell9_balance_indication_dz int8,
ADD COLUMN li_ba_cell10_balance_indication_dz int8,
ADD COLUMN li_ba_cell11_balance_indication_dz int8,
ADD COLUMN li_ba_cell12_balance_indication_dz int8,
ADD COLUMN li_ba_cell13_balance_indication_dz int8,
ADD COLUMN li_ba_cell14_balance_indication_dz int8,
ADD COLUMN li_ba_cell15_balance_indication_dz int8,
ADD COLUMN li_ba_cell16_balance_indication_dz int8,
ADD COLUMN li_ba_bms_switch_event_alarm_status_dz int8,
ADD COLUMN li_ba_bms_current_event_alarm_status_dz int8,
ADD COLUMN li_ba_output_short_circuit_protection_dz int8,
ADD COLUMN li_ba_bms_balance_module_switch_on_dz int8,
ADD COLUMN li_ba_bank_discharge_energy float8,
ADD COLUMN li_ba_mos_temp float8,
ADD COLUMN li_ba_over_temp_point float8,
ADD COLUMN li_ba_high_temp_point float8,
ADD COLUMN li_ba_low_temp_point float8,
ADD COLUMN li_ba_sensor_temp_config float8,
ADD COLUMN li_ba_discharge_mode_status int8,
ADD COLUMN li_ba_overall_running_status int8,
ADD COLUMN li_ba_temp_low int8,
ADD COLUMN li_ba_temp_high int8,
ADD COLUMN li_ba_over_temp int8,
ADD COLUMN li_ba_fuse_alarm int8; 
COMMENT ON COLUMN "public"."bak_li_battery_15m"."li_ba_voltage" IS '锂电池电压'; 
...
ADD COLUMN li_ba_over_temp int8,
ADD COLUMN li_ba_fuse_alarm int8; 
COMMENT ON COLUMN "public"."bak_li_battery_1h"."li_ba_voltage" IS '锂电池电压'; 
