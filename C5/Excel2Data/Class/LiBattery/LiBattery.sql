...
COMMENT ON COLUMN "public"."bak_li_battery_15m"."li_ba_sensor_temp_config" IS '传感器配置';
    ...
    ALTER TABLE bak_li_battery_15m
        ...
        COMMENT ON COLUMN bak_li_battery_15m.li_ba_over_temp_point IS '过温点';
        COMMENT ON COLUMN bak_li_battery_15m.li_ba_high_temp_point IS '高温点';
        COMMENT ON COLUMN bak_li_battery_15m.li_ba_low_temp_point IS '低温点';
        COMMENT ON COLUMN bak_li_battery_15m.li_ba_sensor_temp_config IS '传感器配置';
