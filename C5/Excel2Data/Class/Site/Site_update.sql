...
ADD COLUMN site_dc_alarm_state int8,
ADD COLUMN site_communication_alarm_state1 int8,
ADD COLUMN site_gps varchar(255),
ADD COLUMN site_ac2_high_freq_alarm int8,
ADD COLUMN site_ac2_low_freq_alarm int8,
ADD COLUMN site_ac2_mains_failure int8,
ADD COLUMN site_ac2_ov_alarm int8,
ADD COLUMN site_ac2_phase_failure int8,
ADD COLUMN site_ac2_severe_over_current_alarm int8,
ADD COLUMN site_ac2_slight_over_current_alarm int8,
ADD COLUMN site_ac2_uv_alarm int8,
ADD COLUMN site_ac_controller_eeprom_fault int8,
ADD COLUMN site_ac1_high_freq_alarm int8,
ADD COLUMN site_ac1_low_freq_alarm int8,
ADD COLUMN site_ac1_mains_failure int8,
ADD COLUMN site_ac1_ov_alarm int8,
ADD COLUMN site_ac1_phase_failure int8,
ADD COLUMN site_ac_sample_board_fault int8,
ADD COLUMN site_ac1_severe_over_current_alarm int8,
ADD COLUMN site_ac1_slight_over_current int8,
ADD COLUMN site_ac_spd_fault int8,
ADD COLUMN site_ac_spd_mcb_fault int8,
ADD COLUMN site_ac_trip_alarm int8,
ADD COLUMN site_alarm_ac_under_v int8,
ADD COLUMN site_bus_insulation_fault int8,
ADD COLUMN site_dc_high_voltage_alarm int8,
ADD COLUMN site_dc_low_voltage_alarm int8,
ADD COLUMN site_dc_ov_alarm int8,
ADD COLUMN site_dc_uv_alarm int8,
ADD COLUMN site_eco_running_alarm int8,
ADD COLUMN site_sc200_comm1_fault int8,
ADD COLUMN site_sc200_comm2_fault int8,
ADD COLUMN site_sc200_comm3_fault int8,
ADD COLUMN site_sc210_comm1_fault int8,
ADD COLUMN site_sc210_comm2_fault int8,
ADD COLUMN site_sc310_comm1_fault int8,
ADD COLUMN site_sc310_comm2_fault int8,
ADD COLUMN site_sc310_comm3_fault int8,
ADD COLUMN site_sc320_comm1_fault int8,
ADD COLUMN site_sc320_comm2_fault int8,
ADD COLUMN site_sc320_comm3_fault int8,
ADD COLUMN site_sc320_comm4_fault int8,
ADD COLUMN site_sc320_comm5_fault int8,
ADD COLUMN site_sc330_comm1_fault int8,
ADD COLUMN site_sc330_comm2_fault int8,
ADD COLUMN site_sc330_comm3_fault int8,
ADD COLUMN site_sc330_comm4_fault int8,
ADD COLUMN site_sc330_comm5_fault int8,
ADD COLUMN site_sc340_comm1_fault int8,
ADD COLUMN site_sc340_comm2_fault int8,
ADD COLUMN site_sc340_comm3_fault int8,
ADD COLUMN site_sc501_comm1_fault int8,
ADD COLUMN site_sc501_comm2_fault int8,
ADD COLUMN site_sc501_comm3_fault int8,
ADD COLUMN site_sc501_comm4_fault int8,
ADD COLUMN site_sc900_comm1_fault int8,
ADD COLUMN site_sc900_comm2_fault int8,
ADD COLUMN site_sc900_comm3_fault int8,
ADD COLUMN site_sc920_comm1_fault int8,
ADD COLUMN site_sc920_comm2_fault int8,
ADD COLUMN site_sc930_comm1_fault int8,
ADD COLUMN site_sc930_comm2_fault int8,
ADD COLUMN site_system_spd_fault int8,
ADD COLUMN site_system_total_alarm int8,
ADD COLUMN site_load_power_p float8,
ADD COLUMN site_di_input float8,
ADD COLUMN site_ac1_uv_alarm int8,
ADD COLUMN site_dc_branch_slight_oc_alarm_state1 int8,
ADD COLUMN site_dc_branch1_slight_over_current int8,
ADD COLUMN site_dc_branch2_slight_over_current int8,
ADD COLUMN site_dc_branch_severe_oc_alarm_state1 int8,
ADD COLUMN site_dc_branch1_severe_over_current int8,
ADD COLUMN site_dc_branch2_severe_over_current int8,
ADD COLUMN site_hybrid_controller_mode_switch int8,
ADD COLUMN site_hybrid_controller_manual_to_boost int8,
ADD COLUMN site_hybrid_controller_manual_to_float int8,
ADD COLUMN site_manual_modify_float_charge_voltage float8,
ADD COLUMN site_manual_modify_boost_charge_voltage float8,
ADD COLUMN site_hybrid_battery_status int8,
ADD COLUMN site_battery_bank_voltage float8,
ADD COLUMN site_battery_bank_current float8,
ADD COLUMN site_battery_soc float8,
ADD COLUMN site_battery_remaining_capacity float8,
ADD COLUMN site_battery_total_capacity float8,
ADD COLUMN site_rectifier_total_output_current float8,
ADD COLUMN site_solar_total_output_current float8,
ADD COLUMN site_solar_total_output_voltage float8,
ADD COLUMN site_solar_total_energy float8,
ADD COLUMN site_battery_discharge int8,
ADD COLUMN site_battery_alarm_state1 int8,
ADD COLUMN site_battery_temp float8,
...
ADD COLUMN site_communication_alarm_state2 int8,
ADD COLUMN site_bms1_communication_fault int8,
ADD COLUMN site_bms2_communication_fault int8,
ADD COLUMN site_bms3_communication_fault int8,
ADD COLUMN site_bms4_communication_fault int8,
ADD COLUMN site_bms5_communication_fault int8,
ADD COLUMN site_bms6_communication_fault int8,
ADD COLUMN site_bms7_communication_fault int8,
ADD COLUMN site_bms8_communication_fault int8,
ADD COLUMN site_bms9_communication_fault int8,
ADD COLUMN site_bms10_communication_fault int8,
ADD COLUMN site_bms11_communication_fault int8,
ADD COLUMN site_bms12_communication_fault int8,
ADD COLUMN site_bms13_communication_fault int8,
ADD COLUMN site_bms14_communication_fault int8,
ADD COLUMN site_bms15_communication_fault int8,
ADD COLUMN site_bms16_communication_fault int8; 
...
COMMENT ON COLUMN "public"."bak_site_15m"."site_communication_alarm_state2" IS '通信告警状态2'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms1_communication_fault" IS 'BMS1通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms2_communication_fault" IS 'BMS2通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms3_communication_fault" IS 'BMS3通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms4_communication_fault" IS 'BMS4通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms5_communication_fault" IS 'BMS5通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms6_communication_fault" IS 'BMS6通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms7_communication_fault" IS 'BMS7通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms8_communication_fault" IS 'BMS8通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms9_communication_fault" IS 'BMS9通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms10_communication_fault" IS 'BMS10通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms11_communication_fault" IS 'BMS11通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms12_communication_fault" IS 'BMS12通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms13_communication_fault" IS 'BMS13通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms14_communication_fault" IS 'BMS14通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms15_communication_fault" IS 'BMS15通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_15m"."site_bms16_communication_fault" IS 'BMS16通讯失败'; 
...
COMMENT ON COLUMN "public"."bak_site_1h"."site_communication_alarm_state2" IS '通信告警状态2'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms1_communication_fault" IS 'BMS1通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms2_communication_fault" IS 'BMS2通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms3_communication_fault" IS 'BMS3通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms4_communication_fault" IS 'BMS4通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms5_communication_fault" IS 'BMS5通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms6_communication_fault" IS 'BMS6通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms7_communication_fault" IS 'BMS7通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms8_communication_fault" IS 'BMS8通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms9_communication_fault" IS 'BMS9通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms10_communication_fault" IS 'BMS10通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms11_communication_fault" IS 'BMS11通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms12_communication_fault" IS 'BMS12通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms13_communication_fault" IS 'BMS13通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms14_communication_fault" IS 'BMS14通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms15_communication_fault" IS 'BMS15通讯失败'; 
COMMENT ON COLUMN "public"."bak_site_1h"."site_bms16_communication_fault" IS 'BMS16通讯失败'; 
