...
COMMENT ON COLUMN "public"."iot_solar_15m"."solar_solar_total_alarm_state" IS '太阳能总告警状态'; 
...
COMMENT ON COLUMN "public"."iot_solar_15m"."solar_solar_alarm_selection" IS '太阳能告警选择'; 
...
COMMENT ON COLUMN "public"."iot_solar_15m"."solar_solar_controller_single_no_output" IS '太阳能控制器-单点无输出'; 
COMMENT ON COLUMN "public"."iot_solar_15m"."solar_solar_controller_outside_circuit_short" IS '太阳能控制器-外部电路短路'; 
...
COMMENT ON COLUMN "public"."iot_solar_1h"."solar_solar_total_alarm_state" IS '太阳能总告警状态'; 
...
COMMENT ON COLUMN "public"."iot_solar_1h"."solar_solar_alarm_selection" IS '太阳能告警选择'; 
...
COMMENT ON COLUMN "public"."iot_solar_1h"."solar_solar_controller_single_no_output" IS '太阳能控制器-单点无输出'; 
COMMENT ON COLUMN "public"."iot_solar_1h"."solar_solar_controller_outside_circuit_short" IS '太阳能控制器-外部电路短路'; 
