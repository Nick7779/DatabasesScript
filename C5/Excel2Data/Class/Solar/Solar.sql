...
COMMENT ON COLUMN "public"."bak_solar_15m"."id" IS '主键';
COMMENT ON COLUMN "public"."bak_solar_15m"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."bak_solar_15m"."customer_id" IS '公司ID';
COMMENT ON COLUMN "public"."bak_solar_15m"."site_id" IS '站点ID';
COMMENT ON COLUMN "public"."bak_solar_15m"."asset_id" IS '资产ID';
COMMENT ON COLUMN "public"."bak_solar_15m"."time" IS 'influxdb时间';COMMENT ON COLUMN "public"."bak_solar_15m"."solar_lost_state" IS '太阳能丢失状态'; 
...
solar_pv_vin_low int8,
solar_pv_vin_high int8); 
COMMENT ON COLUMN "public"."bak_solar_1h"."id" IS '主键';
    COMMENT ON COLUMN "public"."bak_solar_1h"."create_time" IS '创建时间';
    COMMENT ON COLUMN "public"."bak_solar_1h"."customer_id" IS '公司ID';
    COMMENT ON COLUMN "public"."bak_solar_1h"."site_id" IS '站点ID';
    COMMENT ON COLUMN "public"."bak_solar_1h"."asset_id" IS '资产ID';
    COMMENT ON COLUMN "public"."bak_solar_1h"."time" IS 'influxdb时间';COMMENT ON COLUMN "public"."bak_solar_1h"."solar_lost_state" IS '太阳能丢失状态'; 
