...
genset_fail_to_close_dse float8,
...
genset_high_current_dse float8,
...
genset_full_power_percentage float8); 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."time" IS 'influxdb时间';COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_engine_coolant_temp" IS '发电机冷却液温度'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_breaker_state" IS '合分闸状态'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_emergency_stop" IS '紧急停机关机'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_low_oil_pressure_warning" IS '低油压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_low_oil_pressure_shutdown" IS '低油压停机告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_oil_pressure_sensor_failure" IS '油位传感器故障'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_coolant_temp_warning" IS '冷却液温度告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_coolant_temp_shutdown" IS '冷却液温度停机告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_coolant_temp_sensor_failure" IS '冷却液温蒂传感器故障'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_low_fuel_level_warning" IS '油位告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_low_fuel_level_shutdown" IS '油位停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_fuel_level_sensor_failure" IS '油位传感器故障'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_underspeed_sd" IS '转速过低停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_sd_start_fail" IS '启动失败'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_voltage_l1l2_warning" IS 'L1L2发电电压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_voltage_l2l3_warning" IS 'L2L3发电电压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_voltage_l3l1_warning" IS 'L3L1发电电压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_voltage_l3l1_sd" IS 'L3L1发电电压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_boc_voltage_unbalance_phph_warning" IS 'BOC发电电压不平衡ph-ph告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_boc_voltage_unbalance_phph_sd" IS 'BOC发电电压不平衡ph-ph Level 2停机告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_boc_voltage_unbalance_phn_warning" IS 'BOC发电电压不平衡ph-n告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_boc_voltage_unbalance_phn_sd" IS 'BOC发电电压不平衡ph-n Level 2停机告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_freq_warning" IS '发电频率告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_freq_sd" IS '发电频率停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l1l2_ov_warning" IS 'L1L2发电过压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l1l2_ov_sd" IS 'L1L2发电过压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l2l3_ov_warning" IS 'L2L3发电过压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l2l3_ov_sd" IS 'L2L3发电过压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l1_uv_warning" IS 'L1发电欠压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l1_uv_sd" IS 'L1发电欠压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l2_uv_warning" IS 'L2发电欠压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l2_uv_sd" IS 'L2发电欠压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_starter_battery_uv_warning" IS '电池欠压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_starter_battery_uv_sd" IS '电池欠压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_starter_battery_ov_warning" IS '电池过压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_starter_battery_ov_sd" IS '电池过压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_remote_start_zz" IS 'zz远程启动'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_remote_stop_zz" IS 'zz远程停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_remote_auto_zz" IS 'zz远程自动'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_remote_manual_zz" IS 'zz远程手动'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_sd_overspeed" IS '超速停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_sd_rpm_measurement_fail" IS '转速测量故障停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_sd_battery_flat" IS '电池耗尽停机 '; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_fail_to_close_dse" IS '发电合闸失败'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_fail_to_close_dse" IS '市电合闸失败'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_oil_pressure_sender_fault_dse" IS '油压传感器故障'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_high_current_dse" IS '发电机过流'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_can_ecu_data_fail_dse" IS 'CAN ECU数据通讯失败'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_low_oil_level_di_input_dse" IS '低油位开关'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_high_temp_di_input_dse" IS '高温开关'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_low_fuel_level_di_input_dse" IS '低燃油位开关量'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_expansion_unit_watchdog_alarm_dse" IS '扩展单元看门狗报警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_overload_alarm_dse" IS '超载报警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_negative_phase_sequence_current_alarm_dse" IS '三相电流不平衡报警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_earth_fault_trip_alarm_dse" IS '接地故障跳闸报警器'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_phase_rotation_alarm_dse" IS '发电机相位旋转报警器'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_auto_voltage_sense_fail_dse" IS '自动电压检测故障'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_loading_freq_alarm_dse" IS '带载频率报警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_loading_voltage_alarm_dse" IS '带载电压报警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_short_circuit_dse" IS '发电机短路'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_high_current_dse" IS '市电过流'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_earth_fault_dse" IS '市电接地故障'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_short_circuit_dse" IS '市电短路'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_ecu_protect_dse" IS 'ECU保护'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_over_current_shutdown_zz" IS '发电过流停机告警'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_l1_active_power" IS '市电L1相有功功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_l2_active_power" IS '市电L2相有功功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_l3_active_power" IS '市电L3相有功功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_total_active_power" IS '市电总有功功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_l1_apparent_power" IS '市电L1相视在功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_l2_apparent_power" IS '市电L2相视在功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_l3_apparent_power" IS '市电L3相视在功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_total_apparent_power" IS '市电总视在功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_l1_reactive_power" IS '市电L1相无功功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_l2_reactive_power" IS '市电L2相无功功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_l3_reactive_power" IS '市电L3相无功功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_mains_total_reactive_power" IS '市电总无功功率'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_cooling_time_setting" IS '冷却时间设定值'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_starter_battery_low_voltage_setting" IS '电池电压低设定值'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_starter_battery_high_voltage_setting" IS '电池电压高设定值'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_ov_shut_down_setting" IS '发电机过压停机设定值'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_ov_warning_setting" IS '发电机过压警告设定值'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_uv_warning_setting" IS '发电机欠压警告设定值'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_uv_breaker_off_cooling_setting" IS '发电机欠压分闸冷却设定值'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_overfreq_warning_setting" IS '发电机频率过高警告设定值'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_full_power_percentage" IS '发电机负载率'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."id" IS '主键';
    ...
    COMMENT ON COLUMN "public"."iot_ac_generator_1h"."time" IS 'influxdb时间';COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_engine_coolant_temp" IS '发电机冷却液温度'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_breaker_state" IS '合分闸状态'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_emergency_stop" IS '紧急停机关机'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_low_oil_pressure_warning" IS '低油压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_low_oil_pressure_shutdown" IS '低油压停机告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_oil_pressure_sensor_failure" IS '油位传感器故障'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_coolant_temp_warning" IS '冷却液温度告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_coolant_temp_shutdown" IS '冷却液温度停机告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_coolant_temp_sensor_failure" IS '冷却液温蒂传感器故障'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_low_fuel_level_warning" IS '油位告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_low_fuel_level_shutdown" IS '油位停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_fuel_level_sensor_failure" IS '油位传感器故障'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_underspeed_sd" IS '转速过低停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_sd_start_fail" IS '启动失败'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_voltage_l1l2_warning" IS 'L1L2发电电压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_voltage_l2l3_warning" IS 'L2L3发电电压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_voltage_l3l1_warning" IS 'L3L1发电电压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_voltage_l3l1_sd" IS 'L3L1发电电压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_boc_voltage_unbalance_phph_warning" IS 'BOC发电电压不平衡ph-ph告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_boc_voltage_unbalance_phph_sd" IS 'BOC发电电压不平衡ph-ph Level 2停机告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_boc_voltage_unbalance_phn_warning" IS 'BOC发电电压不平衡ph-n告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_boc_voltage_unbalance_phn_sd" IS 'BOC发电电压不平衡ph-n Level 2停机告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_freq_warning" IS '发电频率告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_freq_sd" IS '发电频率停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l1l2_ov_warning" IS 'L1L2发电过压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l1l2_ov_sd" IS 'L1L2发电过压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l2l3_ov_warning" IS 'L2L3发电过压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l2l3_ov_sd" IS 'L2L3发电过压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l1_uv_warning" IS 'L1发电欠压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l1_uv_sd" IS 'L1发电欠压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l2_uv_warning" IS 'L2发电欠压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l2_uv_sd" IS 'L2发电欠压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_starter_battery_uv_warning" IS '电池欠压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_starter_battery_uv_sd" IS '电池欠压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_starter_battery_ov_warning" IS '电池过压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_starter_battery_ov_sd" IS '电池过压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_remote_start_zz" IS 'zz远程启动'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_remote_stop_zz" IS 'zz远程停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_remote_auto_zz" IS 'zz远程自动'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_remote_manual_zz" IS 'zz远程手动'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_sd_overspeed" IS '超速停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_sd_rpm_measurement_fail" IS '转速测量故障停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_sd_battery_flat" IS '电池耗尽停机 '; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_fail_to_close_dse" IS '发电合闸失败'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_fail_to_close_dse" IS '市电合闸失败'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_oil_pressure_sender_fault_dse" IS '油压传感器故障'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_high_current_dse" IS '发电机过流'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_can_ecu_data_fail_dse" IS 'CAN ECU数据通讯失败'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_low_oil_level_di_input_dse" IS '低油位开关'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_high_temp_di_input_dse" IS '高温开关'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_low_fuel_level_di_input_dse" IS '低燃油位开关量'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_expansion_unit_watchdog_alarm_dse" IS '扩展单元看门狗报警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_overload_alarm_dse" IS '超载报警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_negative_phase_sequence_current_alarm_dse" IS '三相电流不平衡报警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_earth_fault_trip_alarm_dse" IS '接地故障跳闸报警器'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_phase_rotation_alarm_dse" IS '发电机相位旋转报警器'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_auto_voltage_sense_fail_dse" IS '自动电压检测故障'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_loading_freq_alarm_dse" IS '带载频率报警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_loading_voltage_alarm_dse" IS '带载电压报警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_short_circuit_dse" IS '发电机短路'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_high_current_dse" IS '市电过流'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_earth_fault_dse" IS '市电接地故障'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_short_circuit_dse" IS '市电短路'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_ecu_protect_dse" IS 'ECU保护'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_over_current_shutdown_zz" IS '发电过流停机告警'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_l1_active_power" IS '市电L1相有功功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_l2_active_power" IS '市电L2相有功功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_l3_active_power" IS '市电L3相有功功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_total_active_power" IS '市电总有功功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_l1_apparent_power" IS '市电L1相视在功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_l2_apparent_power" IS '市电L2相视在功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_l3_apparent_power" IS '市电L3相视在功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_total_apparent_power" IS '市电总视在功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_l1_reactive_power" IS '市电L1相无功功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_l2_reactive_power" IS '市电L2相无功功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_l3_reactive_power" IS '市电L3相无功功率'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_mains_total_reactive_power" IS '市电总无功功率'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_cooling_time_setting" IS '冷却时间设定值'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_starter_battery_low_voltage_setting" IS '电池电压低设定值'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_starter_battery_high_voltage_setting" IS '电池电压高设定值'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_ov_shut_down_setting" IS '发电机过压停机设定值'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_ov_warning_setting" IS '发电机过压警告设定值'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_uv_warning_setting" IS '发电机欠压警告设定值'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_uv_breaker_off_cooling_setting" IS '发电机欠压分闸冷却设定值'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_overfreq_warning_setting" IS '发电机频率过高警告设定值'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_full_power_percentage" IS '发电机负载率'; 
