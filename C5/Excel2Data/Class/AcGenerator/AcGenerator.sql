...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_coolant_temp_level2" IS '冷却液温度停机告警'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l1l2_overvoltage_level1" IS 'L1L2发电过压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l1l2_overvoltage_level2" IS 'L1L2发电过压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l2l3_overvoltage_level1" IS 'L2L3发电过压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l2l3_overvoltage_level2" IS 'L2L3发电过压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l1_undervoltage_level1" IS 'L1发电欠压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l1_undervoltage_level2" IS 'L1发电欠压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l2_undervoltage_level1" IS 'L2发电欠压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_l2_undervoltage_level2" IS 'L2发电欠压停机'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_fail_to_close_dse" IS '停止发电失败'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_high_current_dse" IS '发电机电流打'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_15m"."genset_high_temp_switch_dse" IS '高温开关'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_coolant_temp_level2" IS '冷却液温度停机告警'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l1l2_overvoltage_level1" IS 'L1L2发电过压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l1l2_overvoltage_level2" IS 'L1L2发电过压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l2l3_overvoltage_level1" IS 'L2L3发电过压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l2l3_overvoltage_level2" IS 'L2L3发电过压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l1_undervoltage_level1" IS 'L1发电欠压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l1_undervoltage_level2" IS 'L1发电欠压停机'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l2_undervoltage_level1" IS 'L2发电欠压告警'; 
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_l2_undervoltage_level2" IS 'L2发电欠压停机'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_fail_to_close_dse" IS '停止发电失败'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_high_current_dse" IS '发电机电流打'; 
...
COMMENT ON COLUMN "public"."iot_ac_generator_1h"."genset_high_temp_switch_dse" IS '高温开关'; 
