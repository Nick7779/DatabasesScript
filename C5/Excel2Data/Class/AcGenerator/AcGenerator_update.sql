ALTER TABLE bak_ac_generator_15m 
ADD COLUMN genset_engine_coolant_temp float8,
ADD COLUMN genset_controller_mode_switch int8,
ADD COLUMN genset_controller_mode_status int8,
ADD COLUMN genset_remote_on_and_off varchar(255),
ADD COLUMN genset_engine_operation_status int8,
ADD COLUMN genset_l1_active_power float8,
ADD COLUMN genset_l2_active_power float8,
ADD COLUMN genset_l3_active_power float8,
ADD COLUMN genset_total_active_power float8,
ADD COLUMN genset_group_power float8,
ADD COLUMN genset_oil_pressure float8,
ADD COLUMN genset_energy float8,
ADD COLUMN genset_freq float8,
ADD COLUMN genset_l1_current float8,
ADD COLUMN genset_l2_current float8,
ADD COLUMN genset_l3_current float8,
ADD COLUMN genset_engine_speed int8,
ADD COLUMN genset_num_of_stops int8,
ADD COLUMN genset_num_of_starts int8,
ADD COLUMN genset_total_power float8,
ADD COLUMN genset_runtime float8,
ADD COLUMN genset_pf_l1 float8,
ADD COLUMN genset_pf_l2 float8,
ADD COLUMN genset_pf_l3 float8,
ADD COLUMN genset_charging_alternator_voltage float8,
ADD COLUMN genset_starter_battery_voltage float8,
ADD COLUMN genset_l1_power float8,
ADD COLUMN genset_l2_power float8,
ADD COLUMN genset_l3_power float8,
ADD COLUMN genset_l1_voltage_n float8,
ADD COLUMN genset_l1_l2_voltage float8,
ADD COLUMN genset_l3_l1_voltage float8,
ADD COLUMN genset_l2_l3_voltage float8,
ADD COLUMN genset_l2_voltage_n float8,
ADD COLUMN genset_l3_voltage_n float8,
ADD COLUMN genset_remote_reset int8,
ADD COLUMN genset_fuel_level int8,
ADD COLUMN genset_total_fuel_consumption int8,
ADD COLUMN genset_breaker_state int8,
ADD COLUMN genset_fuel_tank_volume int8,
ADD COLUMN genset_auto_led_status_dse int8,
ADD COLUMN genset_test_led_status_dse int8,
ADD COLUMN genset_stop_led_status_dse int8,
ADD COLUMN genset_manual_led_status_dse int8,
ADD COLUMN genset_runtime_minutes_zz int8,
ADD COLUMN genset_emergency_stop_level1 int8,
ADD COLUMN genset_emergency_stop int8,
ADD COLUMN genset_emergency_stop_sensor_failure int8,
ADD COLUMN genset_remote_start_stop float8,
ADD COLUMN genset_remote_start_stop_sensor_failure int8,
ADD COLUMN genset_low_oil_pressure_warning int8,
ADD COLUMN genset_low_oil_pressure_shutdown int8,
ADD COLUMN genset_oil_pressure_sensor_failure float8,
ADD COLUMN genset_coolant_temp_warning int8,
ADD COLUMN genset_coolant_temp_shutdown int8,
ADD COLUMN genset_coolant_temp_sensor_failure int8,
ADD COLUMN genset_low_fuel_level_warning int8,
ADD COLUMN genset_low_fuel_level_shutdown int8,
ADD COLUMN genset_fuel_level_sensor_failure int8,
ADD COLUMN genset_underspeed_sd int8,
ADD COLUMN genset_sd_start_fail int8,
ADD COLUMN genset_voltage_l1l2_warning int8,
ADD COLUMN genset_voltage_l2l3_warning int8,
ADD COLUMN genset_voltage_l3l1_warning int8,
ADD COLUMN genset_voltage_l3l1_sd int8,
ADD COLUMN genset_boc_voltage_unbalance_phph_warning int8,
ADD COLUMN genset_boc_voltage_unbalance_phph_sd int8,
ADD COLUMN genset_boc_voltage_unbalance_phn_warning int8,
ADD COLUMN genset_boc_voltage_unbalance_phn_sd int8,
ADD COLUMN genset_freq_warning int8,
ADD COLUMN genset_freq_sd int8,
ADD COLUMN genset_l1l2_ov_warning int8,
ADD COLUMN genset_l1l2_ov_sd int8,
ADD COLUMN genset_l2l3_ov_warning int8,
ADD COLUMN genset_l2l3_ov_sd int8,
ADD COLUMN genset_l1_uv_warning int8,
ADD COLUMN genset_l1_uv_sd int8,
ADD COLUMN genset_l2_uv_warning int8,
ADD COLUMN genset_l2_uv_sd int8,
ADD COLUMN genset_starter_battery_uv_warning int8,
ADD COLUMN genset_starter_battery_uv_sd int8,
ADD COLUMN genset_starter_battery_ov_warning int8,
ADD COLUMN genset_starter_battery_ov_sd int8,
ADD COLUMN genset_remote_start_zz int8,
ADD COLUMN genset_remote_stop_zz int8,
ADD COLUMN genset_remote_auto_zz int8,
ADD COLUMN genset_remote_manual_zz int8,
ADD COLUMN genset_wrn_charging_alternator_fail int8,
ADD COLUMN genset_sd_charging_alternator_fail int8,
ADD COLUMN genset_wrn_stop_fail int8,
ADD COLUMN genset_sd_overspeed int8,
ADD COLUMN genset_sd_rpm_measurement_fail int8,
ADD COLUMN genset_sd_battery_flat int8,
ADD COLUMN genset_charge_alternator_failure_dse int8,
ADD COLUMN genset_fail_to_stop_dse int8,
ADD COLUMN genset_fail_to_close_dse int8,
ADD COLUMN genset_mains_fail_to_close_dse int8,
ADD COLUMN genset_oil_pressure_sender_fault_dse int8,
ADD COLUMN genset_loss_of_magnetic_pick_up_dse int8,
ADD COLUMN genset_magnetic_pick_up_open_circuit_dse int8,
ADD COLUMN genset_high_current_dse int8,
ADD COLUMN genset_can_ecu_warning_dse int8,
ADD COLUMN genset_can_ecu_shutdown_dse int8,
ADD COLUMN genset_can_ecu_data_fail_dse int8,
ADD COLUMN genset_low_oil_level_di_input_dse int8,
ADD COLUMN genset_high_temp_di_input_dse int8,
ADD COLUMN genset_low_fuel_level_di_input_dse int8,
ADD COLUMN genset_expansion_unit_watchdog_alarm_dse int8,
ADD COLUMN genset_overload_alarm_dse int8,
ADD COLUMN genset_negative_phase_sequence_current_alarm_dse int8,
ADD COLUMN genset_earth_fault_trip_alarm_dse int8,
ADD COLUMN genset_phase_rotation_alarm_dse int8,
ADD COLUMN genset_auto_voltage_sense_fail_dse int8,
ADD COLUMN genset_loading_freq_alarm_dse int8,
ADD COLUMN genset_loading_voltage_alarm_dse int8,
ADD COLUMN genset_short_circuit_dse int8,
ADD COLUMN genset_mains_high_current_dse int8,
ADD COLUMN genset_mains_earth_fault_dse int8,
ADD COLUMN genset_mains_short_circuit_dse int8,
ADD COLUMN genset_ecu_protect_dse int8,
ADD COLUMN genset_overspeed_alarm_shutdown_zz int8,
ADD COLUMN genset_loss_of_speed_signal_alarm_zz int8,
ADD COLUMN genset_over_freq_sd_alarm_zz int8,
ADD COLUMN genset_under_freq_sd_zz int8,
ADD COLUMN genset_over_current_shutdown_zz int8,
ADD COLUMN genset_reverse_power_alarm_shutdown_zz int8,
ADD COLUMN genset_over_power_alarm_shutdown_zz int8,
ADD COLUMN genset_high_temp_input_alarm_shutdown_zz int8,
ADD COLUMN genset_mains_voltage_phase_lagorlead int8,
ADD COLUMN genset_mains_phase_rotation int8,
ADD COLUMN genset_mains_current_lagorlead int8,
ADD COLUMN genset_mains_l1_current float8,
ADD COLUMN genset_mains_l2_current float8,
ADD COLUMN genset_mains_l3_current float8,
ADD COLUMN genset_mains_earth_current float8,
ADD COLUMN genset_mains_l1_active_power float8,
ADD COLUMN genset_mains_l2_active_power float8,
ADD COLUMN genset_mains_l3_active_power float8,
ADD COLUMN genset_mains_total_active_power float8,
ADD COLUMN genset_mains_l1_apparent_power float8,
ADD COLUMN genset_mains_l2_apparent_power float8,
ADD COLUMN genset_mains_l3_apparent_power float8,
ADD COLUMN genset_mains_total_apparent_power float8,
ADD COLUMN genset_mains_l1_reactive_power float8,
ADD COLUMN genset_mains_l2_reactive_power float8,
ADD COLUMN genset_mains_l3_reactive_power float8,
ADD COLUMN genset_mains_total_reactive_power float8,
ADD COLUMN genset_mains_power_factor_l1 float8,
ADD COLUMN genset_mains_power_factor_l2 float8,
ADD COLUMN genset_mains_power_factor_l3 float8,
ADD COLUMN genset_mains_average_power_factor float8,
ADD COLUMN genset_mains_led_status int8,
ADD COLUMN genset_mains_breaker_led_status int8,
ADD COLUMN genset_cooling_time_setting int8,
ADD COLUMN genset_starter_battery_low_voltage_setting int8,
ADD COLUMN genset_starter_battery_high_voltage_setting int8,
ADD COLUMN genset_ov_shut_down_setting int8,
ADD COLUMN genset_ov_warning_setting int8,
ADD COLUMN genset_uv_warning_setting int8,
ADD COLUMN genset_uv_breaker_off_cooling_setting int8,
ADD COLUMN genset_overfreq_warning_setting int8,
ADD COLUMN genset_mains_l1_voltage_n float8,
ADD COLUMN genset_mains_l2_voltage_n float8,
ADD COLUMN genset_mains_l3_voltage_n float8,
ADD COLUMN genset_mains_l1_l2_voltage float8,
ADD COLUMN genset_mains_l2_l3_voltage float8,
ADD COLUMN genset_mains_l3_l1_voltage float8,
ADD COLUMN genset_full_power_percentage int8; 
COMMENT ON COLUMN "public"."bak_ac_generator_15m"."genset_engine_coolant_temp" IS '发电机冷却液温度'; 
...
ALTER TABLE bak_ac_generator_1h 
ADD COLUMN genset_engine_coolant_temp float8,
ADD COLUMN genset_controller_mode_switch int8,
ADD COLUMN genset_controller_mode_status int8,
ADD COLUMN genset_remote_on_and_off varchar(255),
...
ADD COLUMN genset_mains_l3_l1_voltage float8,
ADD COLUMN genset_full_power_percentage int8; 
COMMENT ON COLUMN "public"."bak_ac_generator_1h"."genset_engine_coolant_temp" IS '发电机冷却液温度'; 
